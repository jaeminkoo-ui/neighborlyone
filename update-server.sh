...
# NeighborlyOne - Server Update Script
...
cd ~/neighborly-one || { echo -e "${RED}Error: Project directory not found${NC}"; exit 1; }
...
echo ""
echo -e "🌐 Your application is running at: ${BLUE}http://34.26.14.36:4000${NC}"
echo ""

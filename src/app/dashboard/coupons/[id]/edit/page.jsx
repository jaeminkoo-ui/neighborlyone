...
export default function EditCouponPage() {
  ...
  const fetchCoupon = async () => {
    try {
      ...
      if (response.ok && result.success) {
        ...
        const expirationDate = coupon.expiration_date 
        ...
        alert(`Error: ${result.error || "Failed to fetch coupon"}`);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.ok && result.success) {
        ...
        alert(`Error: ${result.error || "Failed to update coupon"}`);
      }
    } catch (error) {
  ...
  if (!mounted || !user || !business || fetching) {
      ...
      <main className="flex-1 overflow-auto">
        <div className="max-w-4xl mx-auto p-8">
          ...
          <div className="mb-8">
            ...
            <p className="text-gray-600">Update your coupon details</p>
          </div>

    ...
    <div className="flex min-h-screen bg-gray-50">
      ...
      <aside className="w-64 bg-white border-r border-gray-200 flex flex-col">
        ...
        <nav className="flex-1 p-4 space-y-1">
          ...
          {/* <NavItem href="/dashboard/analytics" icon="📈" label="Analytics" active /> */}
      ...
      <main className="flex-1 overflow-auto flex items-center justify-center">
        <div className="text-center px-4 py-12 max-w-2xl">
          ...
          <p className="text-xl text-gray-600 mb-8">
            We're working hard to bring you detailed analytics and insights about your coupons and customer engagement.
          </p>
          <div className="space-y-3 text-left max-w-md mx-auto mb-8">
            <div className="flex items-start gap-3">
              <span className="text-green-500 mt-1">✓</span>
              <div>
                <p className="font-medium text-gray-900">Coupon Performance Tracking</p>
                <p className="text-sm text-gray-600">Views, saves, and redemption rates</p>
              </div>
            </div>
            <div className="flex items-start gap-3">
              <span className="text-green-500 mt-1">✓</span>
              <div>
                <p className="font-medium text-gray-900">Customer Demographics</p>
                <p className="text-sm text-gray-600">Location, age, and usage patterns</p>
              </div>
            </div>
            <div className="flex items-start gap-3">
              <span className="text-green-500 mt-1">✓</span>
              <div>
                ...
                <p className="text-sm text-gray-600">Track how coupons affect your sales</p>
              </div>
            </div>
          </div>
          <Link
